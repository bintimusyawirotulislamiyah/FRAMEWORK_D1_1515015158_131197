	...
	<div class="panel-heading">
        ...
        @foreach ($semuaJadwalDosenMengajar as $dosen)
          <tr>
            ...
            <td>{{ $dosen->dosen->nip or 'nip kosong'}}</td>
            <td>{{ $dosen->matakuliah->title or 'Matakuliah kosong'}}</td>
            <td>
              <div class="btn-group" role="group">
                ...
                <a href="{{url('dosen_matakuliah/'.$dosen->id) }}" class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="top" title="Lihat">
                  <i class="fa fa-eye"></i>
                </a>
                <a href="{{url('dosen_matakuliah/hapus/'.$dosen->id) }}" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="Hapus">
